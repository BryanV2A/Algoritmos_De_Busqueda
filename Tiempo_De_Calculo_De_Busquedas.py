...
def main():
    ...
    print('Tiempo de la busqueda binaria de la lista A es de : \f')

    TimeBusquedaSecuencial = BusquedaSecuencial()
    print(TimeBusquedaSecuencial.busquedaSecuencial(A, DatoAencontrarA))
    print('Tiempo de la busqueda secuencial de la lista A es de : \f')

    # ------------------------------------Lista B------------------------------------------#
    # Se implementa la busqueda de la lista B y se obtiene el tiempo de los algoritmos

    b = TiempoDeBusqueda()
    print(b.BusquedaBinaria(B, DatoAencontrarB, 0, len(B) - 1))
    print('Tiempo la busqueda binaria de la lista B es de : \f')

    TimeBusquedaSecuencial = BusquedaSecuencial()
    print(TimeBusquedaSecuencial.busquedaSecuencial(B, DatoAencontrarB))
    print('Tiempo de la busqueda secuencial de la lista B es de : \f')
